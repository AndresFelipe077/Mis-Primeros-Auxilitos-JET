...
class ContenidoFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'url'         => $this -> faker -> randomElement(['/storage/imagesFactory/policia.png', '/storage/imagesFactory/peluche.png','/storage/imagesFactory/fondo.png' ,'/storage/imagesFactory/logo.png', '/storage/videoFactory/auxilios.mp4']),
            'autor'       => $user -> name,
