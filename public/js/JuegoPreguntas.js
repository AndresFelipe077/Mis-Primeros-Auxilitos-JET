...
function mostrarResultados() {
    ...
    document.getElementById("numCorrectasResultado").textContent = cantidadAcertadas;
    document.getElementById("numIncorrectasResultado").textContent = banderas.length - cantidadAcertadas;
}
