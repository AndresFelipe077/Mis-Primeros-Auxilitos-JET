...
<body>
    ...
    <hr> --}}
        ...
        <section class="social">
            <p>Redes sociales</p>
            <div class="links">
                <img class="m-2" src="{{ asset('img/icons/twitter.png') }}"
                    onclick="location.href=''" alt="Twitter" height="60px" width="60px">
                <img class="m-2" src="{{ asset('img/icons/facebook.png') }}"
                    onclick="location.href=''" alt="Facebook" height="60px" width="60px">
                <img class="m-2" src="{{ asset('img/icons/tiktok.png') }}"
