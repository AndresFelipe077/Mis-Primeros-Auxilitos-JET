    ...
    <div class="container mt-5 animate__animated animate__swing rounded">
        <div class="row align-items-stretch">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-interval="3500"
                        ...
                        <div class="carousel-inner mt-5">
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('img/imgs/bomberito-auxilitos.png') }}"
                                    class="d-block d-flex align-items-center animate__animated animate__heartBeat rounded"
                                    alt="..." width="100%" height="100%">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="bg-secondary rounded">Es muy importante aprender de primeros auxilios
                                    </h5>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('img/imgs/imagenavatar1.png') }}"
                                    class="d-block d-flex align-items-center animate__animated animate__heartBeat rounded"
                                    alt="..." width="100%" height="100%">
                                <div class="carousel-caption d-none d-md-block">
            ...
            <div id="container-login" class="col p-5 rounded">
                <div class="text-end">
                    <img class="animate__animated animate__heartBeat" src="{{ asset('img/logo/logo.png') }}"
                        width="48" alt="">
                </div>
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-floating mb-3 input-wrapper">
                        <input type="password" class="form-control block mt-1 w-full password input password"
                            data-lpignore="true" id="floatingPassword password" name="password"
                    ...
                    <div class="text-center my-3">
                        <span>¿No tienes cuenta? <a class="text-primary h5"
                                href="{{ route('register') }}">Registrate</a></span><br>
                        <span><a class="text-primary h5" href="{{ route('password.request') }}">He olvidado mi
                                contraseña</a></span>
                    </div>
                </form>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-2 ">
                                        <img src="{{ asset('img/Facebook.svg') }}"
                                            onclick="location.href='{{ route('facebook') }}'" alt="..."
                                ...
                                <div class="row align-items-center">
                                    <div class="col-2">
                                        <img src="{{ asset('img/Google.svg') }}"
                                            onclick="location.href='{{ route('google') }}'" alt="..."
                                            height="75px" width="75px">
                                    </div>
                                </div>
                            </button>
