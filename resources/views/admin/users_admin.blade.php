                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="exampleModal{{ $user->id }}">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div
                                                                        class="container text-center mx-auto rounded">
                                                                        <div class="row">
                                                                                ...
                                                                                <div class="card">
                                                                                    <form
                                                                                        ...
                                                                                        <div class="form-floating">
                                                                                            <textarea class="form-control" placeholder="Observacion" id="floatingTextarea2" name="observacion"
                                                                                                style="height: 100px">{{  old('observacion', $user->observacion ) }}</textarea>
                                                                                            <label
                                                                                                for="floatingTextarea2">Observacion</label>
                                                                                        </div>
