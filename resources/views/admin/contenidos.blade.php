                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="imagen card-img-top rounded " src="{{ asset($contenido->url) }}"
                                                ...
                                                <td>
                                                    <form action="{{route('contenido.update',  $contenido)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        @csrf
                                                        @method('put')
                                                        <button class="text-success bg-success rounded-circle border-success m-3">
                                                ...
                                                <td>
                                                    <form method="POST"  action="{{route('contenido.destroy', $contenido)}}">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="text-danger bg-danger rounded-circle border-danger m-3" onclick="return confirm('¿Seguro que deseas eliminar este contenido?')">
