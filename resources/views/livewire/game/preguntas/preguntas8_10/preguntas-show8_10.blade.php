        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="text-center mt-3">
                    <a href="{{ route('game.preguntas_array8_10') }}" class="btn btn-outline-success mt-5"><img
                        ...
                        <div class="card m-3 text-center rounded animate__animated animate__bounceIn"
                            ...
                            <div class="card-body shadow">
                                ...
                                <div class="contenedor rounded">
                                    <img class="imagen rounded mx-auto d-block" id="img"
                                        src="{{ $trivia->image }}" alt="Image of trivia" width="250px" height="250px">
                                </div>
                                ...
                                <div class="text-center mt-3">
                                    <a href="#" class="btn btn-outline-primary "><img
                                            ...
                                            height="50px"></a>
                                    <a href="{{ route('triviaEdit', $trivia) }}" class="btn btn-outline-danger"><img
